...
Additional tasks:
- [Transfer tokens between Ethereum and substrate wallets](https://github.com/superadit98/testnet/blob/main/peaq/token_transfer.md)
...
```
wget -O peaq.sh https://raw.githubusercontent.com/superadit98/testnet/main/peaq/peaq.sh && chmod +x peaq.sh && ./peaq.sh
```
