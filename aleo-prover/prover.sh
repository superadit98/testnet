...
clear
echo "==================================================================="
echo -e '\e[36mAuthor :\e[39m' Mugiwara#6171
echo -e '\e[36mWebsite :\e[39m' upasian.org
echo -e '\e[36mGithub :\e[39m' hiadit.my.id
echo "===================================================================" 
...
echo '=============== PLEASE ENSURE TO BACKUP YOUR PRIVATE AND PUBLIC ADDRESS KEY==================='
